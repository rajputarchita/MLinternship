...
optics = OPTICS(min_samples=5, xi=0.05, min_cluster_size=0.06)  # You can adjust parameters as needed
...
plt.title('OPTICS Clustering on "E6" Dataset')
plt.title('OPTICS Clustering on "E6" Dataset with AMI Score')
plt.title('OPTICS Clustering on "E6" Dataset with Rand Index')
