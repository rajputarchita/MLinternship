...
optics = OPTICS(min_samples=5, xi=0.3, min_cluster_size=0.1, metric='minkowski', p=2)  # You can adjust parameters as needed
...
plt.title('OPTICS Clustering on "jain" Dataset with Rack Index')
plt.xlabel('0')
plt.ylabel('1')
plt.show()
