...
optics = OPTICS(min_samples=5, xi=0.5, min_cluster_size=0.05, metric='minkowski', p=2)  # You can adjust parameters as needed
...
ami_score = adjusted_mutual_info_score(labels, labels)  # Labels are compared to themselves
...
plt.title('OPTICS Clustering on "circle" Dataset with AMI Score')
plt.xlabel('0')
plt.ylabel('1')
plt.show()
