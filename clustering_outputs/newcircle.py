...
df = pd.read_csv('CIRCLEDataset3.csv')
...
optics = OPTICS(min_samples=5, xi=0.09, min_cluster_size=0.09)  # You can adjust parameters as needed
...
plt.title('OPTICS Clustering on "fc1" Dataset with AMI Score')
plt.title('OPTICS Clustering on "fc1" Dataset with Rand Index')
